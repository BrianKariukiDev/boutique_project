<div class=" z-10 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <section class="overflow-hidden bg-slate-900 py-11 font-poppins">
        @foreach ($product as $product)
            <div wire:key='{{$product->id}}' class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
                <div class="flex flex-wrap -mx-4">
                    <div class="z-10 w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{url('storage',$product->images[0])}}' }">
                        ...
                        <div class="lg:pl-20">
                            <div class="mb-8 ">
                                ...
                                <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                                    <span>{{Number::currency($product->sale_price,'Kshs')}}</span>
                                    {{--<span
                                        class="text-base font-normal text-gray-500 line-through dark:text-gray-400">$1800.99</span>--}}
                                </p>
                                <p class="max-w-md text-gray-700 dark:text-gray-400">
                                    {!!Str::markdown($product->description??'<p class="max-w-md text-gray-700 dark:text-gray-400">Shop this awesome product with us</p>')!!}
                                </p>
                            </div>
                            <div class="w-32 mb-8 ">
                                <label for=""
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <button wire:click='addToCartWithQty({{$product->id}}, $wire.quantity)'
                                    ...
                                    <span wire:loading.remove wire:target='addToCartWithQty'>Add to cart</span><span wire:loading wire:target='addToCartWithQty'>Adding...</span></button>
                            </div>
                        </div>
                    </div>
                </div>
