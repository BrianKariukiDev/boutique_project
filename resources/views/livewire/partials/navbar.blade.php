        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/" aria-label="Brand">Karis Boutique</a>
                <div class="md:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('/') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} py-3 md:py-6 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('brands') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/brands">
                            Brands
                        </a>
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('cart') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} flex items-center hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/cart">
                            ...
                            <span class="mr-1">Cart</span> <span
                                class="py-0.5 px-1.5 rounded-full text-xs font-medium bg-blue-50 border border-blue-200 text-blue-600">{{ $cart_count }}</span>
                        </a>

                        @guest
                            <div class="pt-3 md:pt-0">
                                <button wire:navigate href="/login"
                                    class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        ...
                        @auth
                            <div x-data="{ open: false }" class="relative inline-block">
                                ...
                                <div x-show="open" @click.away="open = false" x-transition
                                    class="fixed right-0 mt-2 w-48 bg-white shadow-lg rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 z-50">
                                    <a class="block py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                        href="/my-orders">
                                        My Orders
                                    </a>
