<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="flex flex-col md:flex-row gap-4 mt-4">
      <div class="md:w-3/4">
        ...
        <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
          <h1 class="font-3xl font-bold text-slate-500 mb-3">Pickup Point</h1>
          <div class="flex justify-between items-center">
            <div>
              <p>{{$pickup_point->name}},{{$pickup_point->city}}</p>
            </div>
            <div>
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Subtotal</span>
            <span>{{Number::currency($order->grand_total,'Kshs')}}</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
            <span>0</span>
          ...
          <div class="flex justify-between mb-2">
            ...
            <span class="font-semibold">{{Number::currency($order->grand_total,'Kshs')}}</span>
          </div>
